...
- [.NET Framework 4.7.2](https://dotnet.microsoft.com/download/dotnet-framework) or later, which is included in Windows 10 1803 (April 2018 Update), Windows Server 2019, and later
...
1. You can add this selector object to `configuration.json` by inserting it into the `eventLogSelectors` array.
    ```json
    {
        ...
        "eventLogSelectors": [
            {
                "friendlyName": "Remote Desktop Services",
                "logName": "Security",
                "eventId": 4625,
